package {
	...
	public class HoverDragController
	{
		...
		private var _xRad : Number = 10;
		private var _yRad : Number = -0.5;
		private var _targetXRad : Number = -0.7;
		private var _targetYRad : Number = -0.1;
        private var _targetRadius : Number = 150;
		...
		private var max:Number = 1500000;
		private var min:Number = 800000;
        /**
         * Updates camera distance
         */
        private function onMouseWheel(event:MouseEvent) : void
        {
			var delt:Number = event.delta*5*(_targetRadius/100);
            _targetRadius -= delt;
			
			/*if(!(_targetRadius>min&&_targetRadius<max))
				_targetRadius += delt;*/
        }
